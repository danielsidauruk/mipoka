...
class PemeriksaBerandaPage extends StatefulWidget {
  const PemeriksaBerandaPage({super.key});

  @override
  State<PemeriksaBerandaPage> createState() => _PemeriksaBerandaPageState();
}

class _PemeriksaBerandaPageState extends State<PemeriksaBerandaPage> {
  @override
  void initState() {
