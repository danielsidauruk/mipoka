...
class MobilePemeriksaPengajuanLaporanKegiatan1Page extends StatefulWidget {
  ...
  @override
  State<MobilePemeriksaPengajuanLaporanKegiatan1Page> createState() => _MobilePemeriksaPengajuanLaporanKegiatan1PageState();
}

class _MobilePemeriksaPengajuanLaporanKegiatan1PageState extends State<MobilePemeriksaPengajuanLaporanKegiatan1Page> {
  final TextEditingController _commentNamaKegiatanController = TextEditingController();
  final TextEditingController _commentPencapaianController = TextEditingController();
                ...
                children: [
                  ...
                  CustomButton(
                    navigation: () => Navigator.pushNamed(
                      context,
                      mobilePemeriksaPengajuanLaporanKegiatan2PageRoute,
                    ),
                    text: 'Berikutnya',
                  ),
                ],
