...
Future<void> init() async {
  ...
  locator.registerLazySingleton(() => PeriodeUseCase(mipokaRepositories: locator()));
  locator.registerLazySingleton(() => PesertaUseCase(mipokaRepositories: locator()));
  ...
  locator.registerLazySingleton(() => RincianLaporanUseCase(mipokaRepositories: locator()));
  ...
  locator.registerLazySingleton(() => UserUseCase(mipokaRepositories: locator()));
